...
public class ServerTests {
	...
	private static String url = "http://localhost:8080/AndroidServer/services/";
	private static Soap soap = new Soap(url);
	private static  User a = new User(0, 23, "aemail", "aphoneNbr", "afirstName","alastName");
	private static  User b = new User(0, 23, "bemail", "bphoneNbr", "bfirstName","blastName");
	private static  User c = new User(0, 23, "cemail", "cphoneNbr", "cfirstName","clastName");
	private static  User d = new User(0, 23, "demail", "dphoneNbr", "dfirstName","dlastName");
	private static  User e = new User(0, 23, "eemail", "ephoneNbr", "efirstName","elastName");
	...
	public void cuserIDCEstablised()
	{
		...
		try {
			c.setUserID(soap.createCreateUserRequest(c.getAge(), c.getEmail(),c.getFristName(), c.getLastName(), "c", "c",c.getPhoneNbr()));
	...
	public void kAequalsDB()
	{
		...
		assertEquals("user a phoneNbr == db phoneNbr", true,
				a.getEmail().equals(aa.getEmail()));
		
		assertEquals("user a first name == db firstname", true,
				a.getFristName().equals(aa.getFristName()));
		assertEquals("user a last name == db lastname", true,
				a.getLastName().equals(aa.getLastName()));
	...
	public void lBequalsDB()
	{
		...
		assertEquals("user b phoneNbr == db phoneNbr", true,
				b.getEmail().equals(bb.getEmail()));
		assertEquals("user b first name == db firstname", true,
				b.getFristName().equals(bb.getFristName()));
		assertEquals("user b last name == db lastname", true,
				b.getLastName().equals(bb.getLastName()));
	...
	public void mCequalsDB()
	{
		...
		assertEquals("user c phoneNbr == db phoneNbr", true,
				c.getEmail().equals(cc.getEmail()));
		
		assertEquals("user c first name == db firstname", true,
				c.getFristName().equals(cc.getFristName()));
		
		assertEquals("user c last name == db lastname", true,
				c.getLastName().equals(cc.getLastName()));
	...
	public void nDequalsDB()
	{
		...
		assertEquals("user d phoneNbr == db phoneNbr", true,
				d.getEmail().equals(dd.getEmail()));
		
		assertEquals("user d first name == db firstname", true,
				d.getFristName().equals(dd.getFristName()));
		
		assertEquals("user d last name == db lastname", true,
				d.getLastName().equals(dd.getLastName()));
	...
	public void oEequalsDB()
	{
		...
		assertEquals("user e phoneNbr == db phoneNbr", true,
				e.getEmail().equals(ee.getEmail()));
		
		assertEquals("user e first name == db firstname", true,
				e.getFristName().equals(ee.getFristName()));
		
		assertEquals("user e last name == db lastname", true,
				e.getLastName().equals(ee.getLastName()));
	}
	...
	public void uCheckAWrong()
	{
		...
		assertEquals("user a email == db email", false,	a.getEmail().equals(aa.getEmail()));
		
		assertEquals("user a phoneNbr == db phoneNbr", false,a.getEmail().equals(aa.getEmail()));
		
		assertEquals("user a first name == db firstname", false,a.getFristName().equals(aa.getFristName()));
		
		assertEquals("user a last name == db lastname", false,a.getLastName().equals(aa.getLastName()));
	...
	public void vcheckBWrong()
	{
		...
		assertEquals("user b email == db email", false,b.getEmail().equals(bb.getEmail()));
		
		assertEquals("user b phoneNbr == db phoneNbr", false,b.getEmail().equals(bb.getEmail()));
		
		assertEquals("user b first name == db firstname", false,b.getFristName().equals(bb.getFristName()));
		
		assertEquals("user b last name == db lastname", false,b.getLastName().equals(bb.getLastName()));
	...
	public void wcheckCWrong()
	{
		...
		assertEquals("user c email == db email", false,	c.getEmail().equals(cc.getEmail()));
		
		assertEquals("user c phoneNbr == db phoneNbr", false,c.getEmail().equals(cc.getEmail()));
		
		assertEquals("user c first name == db firstname", false,c.getFristName().equals(cc.getFristName()));
		
		assertEquals("user c last name == db lastname", false,c.getLastName().equals(cc.getLastName()));
	...
	public void xcheckDWrong()
	{
		...
		assertEquals("user d email == db email", false,	d.getEmail().equals(dd.getEmail()));
		
		assertEquals("user d phoneNbr == db phoneNbr", false,d.getEmail().equals(dd.getEmail()));
		
		assertEquals("user d first name == db firstname", false,d.getFristName().equals(dd.getFristName()));
		
		assertEquals("user d last name == db lastname", false,d.getLastName().equals(dd.getLastName()));
	...
	public void ycheckEWrong()
	{
		...
		assertEquals("user e email == db email", false,	e.getEmail().equals(ee.getEmail()));
		
		assertEquals("user e phoneNbr == db phoneNbr", false,e.getEmail().equals(ee.getEmail()));
		
		assertEquals("user e first name == db firstname", false,e.getFristName().equals(ee.getFristName()));
		
		assertEquals("user e last name == db lastname", false,e.getLastName().equals(ee.getLastName()));
	}
	@Test
