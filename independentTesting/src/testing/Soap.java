...
public class Soap {
	...
	private void createEditAcctRequest(int age, String email, String firstName,
	...
	private void createCreateUserRequest(int age, String email,
	...
	private void createGetUserDataRequest(int userID) throws Exception {
		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();
		SOAPPart soapPart = soapMessage.getSOAPPart();
	...
	private void createDeleteUSerRequest(int userID) throws Exception {
		MessageFactory messageFactory = MessageFactory.newInstance();
		SOAPMessage soapMessage = messageFactory.createMessage();
		SOAPPart soapPart = soapMessage.getSOAPPart();
